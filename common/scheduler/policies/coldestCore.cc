...
/**
 * @brief Maps a task to specific cores depending on temperatures of all cores
 * 
 * @param taskName 
 * @param taskCoreRequirement 
 * @param availableCoresRO 
 * @param activeCores 
 * @return std::vector<int> list of cores for this application (in one thread per core model)
 */
...
/**
 * @brief Gives which applications should migrate from one core to another
 * 
 * @param time 
 * @param taskIds 
 * @param activeCores 
 * @return std::vector<migration> Arbitrary long list of migrations to be performed
 */
        ...
        if (activeCores.at(c))
        {
            ...
            if (temperature > criticalTemperature)
            {
                ...
                else
                {
                    ...
                    m.fromCore = c;
                    m.toCore = targetCore;
                    m.swap = false;                             // indicates that both source and target core are used and threads should be swapped
...
/**
 * @brief Determines coldest avaiable core
 * 
...
/**
 * @brief Creates a log printout of all core temperatures
 * 
 * @param availableCores 
 */
